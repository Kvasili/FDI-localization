...
'''
This module contains the DataPreparer class, which is responsible for loading, preprocessing, and preparing
the data for training and validation of the FDI localization model. 
It includes methods for loading data from CSV files, normalizing features using min-max scaling based on pre-computed min and max values, 
converting data into sequences suitable for time series modeling, and creating PyTorch DataLoaders for efficient training and validation.
